        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <form action="<c:url value="/messages/add.do"/>" method="POST">
                    ...
                    <textarea class="form-control" name="text" placeholder="Enter here for tweet..."
                              rows="3"></textarea>
                    <br>
                        ...
                        <li class="media">
                            <div class="media-body">
                                <div class="text-muted pull-right">
                                    <small class="text-muted"><fmt:formatDate type="date"
                                                                              value="${msg.created}"/></small>
                                    <a style="text-decoration: none; color:inherit;"
                                       href="<c:url value="/messages/delete.do?userId=${user.id}&messageId=${msg.id}"/>">
