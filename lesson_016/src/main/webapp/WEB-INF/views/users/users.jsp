        ...
        <c:forEach items="${users}" var="user" varStatus="status">
            ...
            <tr>
                <td><a style="text-decoration: none; color:inherit;"
                       href="<c:url value="/user.do?id=${user.id}"/>"><c:out value="${user.username}"/></a></td>
                ...
                <td>
                    <a style="text-decoration: none; color:inherit;"
                       href="<c:url value="/users/edit.do?id=${user.id}"/>"><span class="glyphicon glyphicon-edit"
                                                                                  aria-hidden="true"></span></a>&nbsp;
                    <a style="text-decoration: none; color:inherit;"
                       href="<c:url value="/users/delete.do?id=${user.id}"/>"><span class="glyphicon glyphicon-remove"
                                                                                    aria-hidden="true"></span></a>
                </td>
            </tr>
        </c:forEach>
