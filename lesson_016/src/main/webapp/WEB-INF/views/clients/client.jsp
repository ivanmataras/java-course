    ...
    <div>
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <textarea class="form-control" id="text" name="text" placeholder="Enter here for tweet..."
                          rows="3"></textarea>
                <br>
                <button type="button" onclick="return createMessage();" class="btn btn-default pull-right">Добавить
                </button>
